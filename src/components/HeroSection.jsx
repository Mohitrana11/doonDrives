      ...
      <section className="w-full h-full  relative flex flex-col flex-wrap lg:flex-row items-center justify-between px-[4%] py-12 mt-18 sm:mt-15 lg:py-20 overflow-hidden bg-gray-110">
        ...
        <div className="relative w-full lg:w-[50%] h-[500px] sm:h-[500px] md:h-[600px]  lg:h-[700px] flex justify-center items-center  overflow-hidden">
          ...
          <div className="absolute inset-0 flex justify-center items-center">
            ...
            <div className="absolute sml:w-[250px] sml:h-[200px]  w-[200px] h-[250px] sm:w-[320px] sm:h-[320px] md:w-[350px] md:h-[350px] lg:w-[330px] lg:h-[330px] xl:w-[400px] xl:h-[400px] 2xl:h-[450px] 2xl:w-[450px] rounded-full bg-gradient-to-tr from-orange-600 via-key-500 to-white blur-[1px]  cir-box"></div>
          ...
          >
            ...
            <p className="text-gray-500 sml:text-[12px] text-xs flex items-center gap-1">
              <FaMapMarkerAlt className="text-sky-500" /> Rudraprayag,
              Uttarakhand
            </p>
          </motion.div>
          ...
          {/* 🛫 dun Airport Tag */}
          <motion.div className="absolute sml:top-20  sml:right-55 top-6 sm:-top-2 sm:text-xl md:top-2 right-[45%] sm:right-[50%] md:right-[47%] lg:top-15 xl:top-6 2xl:top-0 bg-white shadow-md rounded-full px-4 py-2 flex items-center gap-2 z-20 ">
