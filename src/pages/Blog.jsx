    ...
    <div className="bg-white text-gray-800 w-full px-[5%] py-16 mt-[60px]">
      ...
      <motion.section className="max-w-5xl mx-auto text-center mb-16">
        ...
        <motion.p
          ...
          transition={{ duration: 0.7 }}
        >
          Welcome to <strong>Dun Drives</strong> — your trusted tour and travel
      ...
      >
        ...
        <div className="lg:w-[50%] ">
          ...
          >
            ...
            MUVs. Whether you need a <strong>local taxi in Dehradun</strong>, a{" "}
            <strong>Dehradun to Delhi cab</strong>, or a{" "}
          ...
          >
            With experienced drivers and 24/7 availability, we ensure your trip
            is safe and stress-free. From airport transfers to family tours, we
            provide the <strong>best taxi service in Dehradun</strong> at the
      ...
      >
        ...
        <div>
          ...
          >
            ...
            Chamoli, Uttarakhand. As one of India’s famous Char Dham pilgrimage
            sites, it draws thousands of devotees every year.
          </motion.p>
          <motion.p
            className="text-gray-600 leading-relaxed mb-4"
            initial={{ opacity: 0, y: 50 }}
          ...
          >
            ...
            <strong>dun Drives</strong>, you can choose from Sedans, Hatchbacks,
            and SUVs — all driven by experienced and professional drivers.
          </motion.p>
          <motion.p
            className="text-gray-600 leading-relaxed"
            initial={{ opacity: 0, y: 50 }}
          ...
          >
            ...
            <strong>540 km</strong> and takes roughly <strong>15 hours</strong>{" "}
            by car. You can book online anytime through our easy interface and
            enjoy the <strong>best taxi service from Delhi to Badrinath</strong>{" "}
            at affordable prices with comfort and reliability.
          </motion.p>
        </div>
      </motion.section>
      ...
      <motion.section
        ...
        transition={{ duration: 0.7 }}
      >
        <h2 className="text-3xl font-bold mb-6">Our Services & Experiences</h2>
